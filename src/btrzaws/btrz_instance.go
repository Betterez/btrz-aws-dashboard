...
func LoadFromAWSInstance(instance *ec2.Instance) *BetterezInstance {
	result := &BetterezInstance{
		...
		ServiceType:  GetTagValue(instance, "Service-Type"),
...
// IsAPIInstance - checks if api instance
func (instance *BetterezInstance) IsAPIInstance() bool {
	if instance.ServiceType == "http" && instance.PathName != "/" {
		return true
	}
	return false
}
...
func (instance *BetterezInstance) IsAppInstance() bool {
	if instance.ServiceType == "http" && instance.PathName == "/" {
		return true
	}
	return false
...
func (instance *BetterezInstance) IsWorkerInstance() bool {
	if instance.ServiceType == "worker" {
		return true
	}
	return false
}

// IsMongoInstance - checks if this is a mongo instance
func (instance *BetterezInstance) IsMongoInstance() bool {
	if instance.ServiceType == "mongo" {
		return true
	}
	return false
}
